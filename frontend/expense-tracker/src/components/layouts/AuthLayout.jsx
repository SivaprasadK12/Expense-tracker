...
const AuthLayout = ({children}) => {
  return (
    ...
    <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-no-repeat bg-center overflow-hidden p-8 relative'>
        ...
        <div className='w-48 h-56 rounded-[40px] border-[20px] border-fuschia-600 absolute top-[30%] -right-full' />
        <div className='w-48 h-48 rounded-[40px] bg-violet-500 absolute -bottom-7 -left-full' />
        ...
        <img src={loginImage} className='w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15' />
    </div>
